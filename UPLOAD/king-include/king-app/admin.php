...
*/
	{
		...
		if ($level>=QA_USER_LEVEL_ADMIN) {
			...
			$navigation['admin/ai']=array(
				'label' => qa_lang_html('admin/ai'),
				'url' => qa_path_html('admin/ai'),
			);
			...
			$navigation['admin/membership']=array(
				'label' => qa_lang_html('misc/premium'),
				'url' => qa_path_html('admin/membership'),
				'selected_on' => array('admin/membership$', 'admin/credits$', 'admin/homepage$', 'admin/adfree$', 'admin/creditsopt'),
			);
...
function king_sub_navigation($subtitle=null)
/*
	Return the sub navigation structure common to admin pages
*/
	{
		...
		if ($level>=QA_USER_LEVEL_ADMIN) {
			if ('mem' === $subtitle) {
				...
				$navigation['admin/credits']=array(
					'label' => qa_lang_html('misc/credits'),
					'url' => qa_path_html('admin/credits'),
				);
				if ( qa_opt( 'enable_credits' ) ) {
					$navigation['admin/creditsopt']=array(
						'label' => qa_lang_html('misc/creditsopt'),
						'url' => qa_path_html('admin/creditsopt'),
					);
				}
				$navigation['admin/homepage']=array(
					'label' => qa_lang_html('misc/homepage'),
					'url' => qa_path_html('admin/homepage'),
				);
				$navigation['admin/adfree']=array(
					'label' => qa_lang_html('options/adfree'),
					'url' => qa_path_html('admin/adfree'),
				);
			} else {
				$navigation['admin/manage']=array(
