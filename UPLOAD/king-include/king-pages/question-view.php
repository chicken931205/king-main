	...
	//	Buttons for operating on the question
		...
		if (!$formrequested) { // don't show if another form is currently being shown on page
			...
			if ($question['editbutton'])
				$buttons['edit']=array(
					'tags' => 'name="q_doedit" data-toggle="tooltip" data-placement="top" title="'.qa_lang_html('question/edit_button').'"',
			...
			if ($question['flagbutton'])
				$buttons['flag']=array(
					'tags' => 'name="q_doflag" data-toggle="tooltip" data-placement="top" title="'.qa_lang_html($question['flagtohide'] ? 'question/flag_hide_button' : 'question/flag_button').'"'.$clicksuffix,
					'label' => '<i class="fa-regular fa-flag"></i>',
					'popup' => qa_lang_html('question/flag_q_popup'),
				);

			if ($question['unflaggable'])
				$buttons['unflag']=array(
					'tags' => 'name="q_dounflag" data-toggle="tooltip" data-placement="top" title="'.qa_lang_html('question/unflag_button').'"'.$clicksuffix,
					'label' => '<i class="fa-solid fa-flag"></i>',
					'popup' => qa_lang_html('question/unflag_popup'),
				);

			if ($question['clearflaggable'])
				$buttons['clearflags']=array(
					'tags' => 'name="q_doclearflags" data-toggle="tooltip" data-placement="top" title="'.qa_lang_html('question/clear_flags_button').'"'.$clicksuffix,
			...
			if ($question['hideable'])
				$buttons['hide']=array(
					'tags' => 'name="q_dohide" data-toggle="tooltip" data-placement="top" title="'.qa_lang_html('question/hide_button').'"'.$clicksuffix,
			...
			if ($question['deleteable'])
				$buttons['delete']=array(
					'tags' => 'name="q_dodelete" data-toggle="tooltip" data-placement="top" title="'.qa_lang_html('question/delete_button').'"'.$clicksuffix,
