...
*/
	...
	*/
		...
		$tables=array(
			...
			'buyposts' => array(
				'id' => 'INT UNSIGNED NOT NULL AUTO_INCREMENT',
				'buyer' => 'INT UNSIGNED', // null means it's stored on disk in QA_BLOBS_DIRECTORY
				'seller' => 'INT UNSIGNED', // name of source file (if appropriate)
				'postid' => 'INT UNSIGNED', // name of source file (if appropriate)
				'price' => 'INT UNSIGNED',
				'created' => 'DATETIME', // when it was created
				'PRIMARY KEY (id)',
			),			
